...
/*SF_DATA;ver:1.04;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,dith:2,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:34377,y:32712,varname:node_1,prsc:2|diff-4460-OUT,emission-163-OUT;n:type:ShaderForge.SFN_Tex2d,id:3,x:33700,y:32537,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:node_2830,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:9,x:33700,y:32804,ptovrint:False,ptlb:Emissive,ptin:_Emissive,varname:node_9334,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Vector1,id:35,x:33700,y:32729,varname:node_35,prsc:2,v1:0;n:type:ShaderForge.SFN_Time,id:41,x:32890,y:33043,varname:node_41,prsc:2;n:type:ShaderForge.SFN_Color,id:53,x:33700,y:33121,ptovrint:False,ptlb:Fresnel_Color,ptin:_Fresnel_Color,varname:node_67,prsc:2,glob:False,c1:1,c2:0.6,c3:0,c4:1;n:type:ShaderForge.SFN_Sin,id:91,x:33295,y:33107,varname:node_91,prsc:2|IN-114-OUT;n:type:ShaderForge.SFN_Add,id:102,x:33490,y:33060,varname:node_102,prsc:2|A-331-OUT,B-91-OUT;n:type:ShaderForge.SFN_Multiply,id:114,x:33120,y:33107,varname:node_114,prsc:2|A-41-T,B-116-OUT;n:type:ShaderForge.SFN_ValueProperty,id:116,x:32890,y:33183,ptovrint:False,ptlb:Pulse_Speed,ptin:_Pulse_Speed,varname:node_1124,prsc:2,glob:False,v1:6;n:type:ShaderForge.SFN_SwitchProperty,id:132,x:33910,y:32757,ptovrint:False,ptlb:Emissive_On/Off,ptin:_Emissive_OnOff,varname:node_5679,prsc:2,on:False|A-35-OUT,B-9-RGB;n:type:ShaderForge.SFN_Add,id:163,x:34109,y:32787,varname:node_163,prsc:2|A-132-OUT,B-363-OUT;n:type:ShaderForge.SFN_Fresnel,id:225,x:33700,y:32975,varname:node_225,prsc:2|EXP-102-OUT;n:type:ShaderForge.SFN_Slider,id:331,x:33138,y:33037,ptovrint:False,ptlb:Fresnel_Width,ptin:_Fresnel_Width,varname:node_1261,prsc:2,min:1.5,cur:1.5,max:5;n:type:ShaderForge.SFN_Multiply,id:363,x:33911,y:33048,varname:node_363,prsc:2|A-225-OUT,B-53-RGB;n:type:ShaderForge.SFN_Add,id:4460,x:34226,y:32563,varname:node_4460,prsc:2|A-3-RGB,B-7562-OUT;n:type:ShaderForge.SFN_Multiply,id:7562,x:34031,y:32592,varname:node_7562,prsc:2|A-3-RGB,B-5000-OUT;n:type:ShaderForge.SFN_ValueProperty,id:5000,x:33850,y:32656,ptovrint:False,ptlb:Corrective_Glow,ptin:_Corrective_Glow,varname:node_7740,prsc:2,glob:False,v1:1;proporder:3-132-9-116-331-53-5000;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float3 emissive = (lerp( 0.0, _Emissive_var.rgb, _Emissive_OnOff )+(pow(1.0-max(0,dot(normalDirection, viewDirection)),(_Fresnel_Width+sin((node_41.g*_Pulse_Speed))))*_Fresnel_Color.rgb));
/// Final Color:
